...
public function store(Request $request)
{
    try {
        $validated = $request->validate([
            'po_number'   => 'required|string', // Tambahkan validasi ini
        ...
        $purchase = Purchase::create([
            'purchase_number' => 'PUR-' . now()->format('YmdHis'),
            'po_number'       => $validated['po_number'], // Tambahkan ini
        ...
        // ... (lanjutkan kode foreach item Anda)
